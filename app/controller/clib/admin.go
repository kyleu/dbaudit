...
import (
	...
	"github.com/kyleu/dbaudit/app/lib/log"
	"github.com/kyleu/dbaudit/app/lib/user"
	"github.com/kyleu/dbaudit/app/util"
	"github.com/kyleu/dbaudit/views/vadmin"
)
...
func Admin(w http.ResponseWriter, r *http.Request) {
	...
	controller.Act(key, w, r, func(as *app.State, ps *cutil.PageState) (string, error) {
		if len(path) == 0 {
			...
			return controller.Render(r, as, &vadmin.Settings{Perms: user.GetPermissions()}, ps, "admin")
		}
		...
		case "migrations":
			...
			return controller.Render(r, as, &vadmin.Migrations{Available: ms, Applied: am}, ps, "admin", "Migrations**database")
		case "modules":
