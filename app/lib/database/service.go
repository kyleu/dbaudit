...
import (
	...
	"github.com/kyleu/dbaudit/app/lib/telemetry/dbmetrics"
	"github.com/kyleu/dbaudit/app/util"
	"github.com/kyleu/dbaudit/queries"
	"github.com/kyleu/dbaudit/queries/schema"
)
...
func (s *Service) Healthcheck(dbName string, db *sqlx.DB) error {
	...
	if err != nil || res.Err() != nil {
		...
		if strings.Contains(err.Error(), "does not exist") {
			return errors.Wrapf(err, "database [%s] does not exist; run the following:\n"+schema.CreateDatabase(), dbName)
		}
